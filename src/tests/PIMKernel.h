...
class PIMKernel
{
  public:
    ...
    */
    ...
    unsigned getResultColBinaryGemv(int input_dim, int output_dim);
    ...
    void preloadBinaryGemv(NumpyBurstType* operand, unsigned starting_row = 0, unsigned starting_col = 0);
    ...
    */
    ...
    void executeBinaryGemv(NumpyBurstType* w_data, NumpyBurstType* i_data);
    ...
    void computeBinaryGemv(NumpyBurstType* data, int num_input_tiles, int num_output_tile,
                            int input_tile, int output_tile, int batch_idx, pimBankType bank_types);
